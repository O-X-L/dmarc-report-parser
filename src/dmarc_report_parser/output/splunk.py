...
from ..utils.main import human_timestamp_to_unix_timestamp
...
class HECClient(object):
    ...
    def __init__(self, url, access_token, index,
                 source="dmarc_report_parser", verify=True, timeout=60):
        """
        ...
        self.session.headers = {
            "User-Agent": "dmarc_report_parser/{0}".format(__version__),
