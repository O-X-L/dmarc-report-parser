...
from ..main import parsed_aggregate_reports_to_csv_rows, \
...
class ContextFilter(logging.Filter):
    ...
    def filter(self, record):
        record.dmarc_report_parser = log_context_data.dmarc_report_parser
        return True
...
class GelfClient(object):
    ...
    def __init__(self, host, port, mode):
        ...
        self.host = host
        self.port = port
        self.logger = logging.getLogger('dmarc_report_parser_syslog')
    ...
    def save_aggregate_report_to_gelf(self, aggregate_reports):
        ...
        for row in rows:
            log_context_data.dmarc_report_parser = row
            self.logger.info('dmarc_report_parser aggregate report')

        log_context_data.dmarc_report_parser = None
